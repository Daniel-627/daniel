    ...
    <div>
      <header className="mx-auto max-w-6xl px-8 pb-16 pt-24 md:pt-[120px]">
        ...
        <p className="mt-6 max-w-[560px] text-[15.5px] text-text-secondary">
          The same four stages apply whether we&apos;re building a product or
          shaping a brand — what changes is the work inside each one.
        </p>
      </header>
      ...
      {steps.map((s) => (
        <section
          key={s.num}
          className="mx-auto max-w-6xl border-t border-border px-8 py-20"
        >
              ...
              <div className="mt-10 grid gap-8 sm:grid-cols-2">
                ...
                {s.whatINeed && s.whatINeed.length > 0 && (
                  <div>
                    ...
                    <ul className="space-y-2 text-[14.5px] text-text-secondary">
                      {s.whatINeed.map((w) => (
